        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                    <a href="{{ asset('front/images/product_image/large/'.$productDetails['product_image']) }}">
                        <img src="{{ asset('front/images/product_image/large/'.$productDetails['product_image']) }}"
                         alt="" width="500" height="500" />
                    </a>

                </div>
                <div class="thumbnails" style="margin-top:30px;">
                    <a href="{{ asset('front/images/product_image/large/'.$productDetails['product_image']) }}" data-standard="{{ asset('front/images/product_image/small/'.$productDetails['product_image']) }}">
                        <img width="120" height="120" src="{{ asset('front/images/product_image/small/'.$productDetails['product_image']) }}" alt="" />
                    </a>
                @foreach($productDetails['images'] as $image)
                <a href="{{ asset('front/images/product_image/large/'.$image['image']) }}" data-standard="{{ asset('front/images/product_image/small/'.$image['image']) }}">
                    <img width="120" height="120" src="{{ asset('front/images/product_image/small/'.$image['image']) }}" alt="Product" />
                </a>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="all-information-wrapper">
                    ...
                    <div class="section-1-title-breadcrumb-rating">
                        <div class="product-title">
                            <h1>
                                <a href="#">{{ $productDetails['product_name'] }}</a>
                            </h1>
                        </div>
                        <ul class="bread-crumb">
                            <li class="has-separator">
                            ...
                            <li class="has-separator">
                                <a href="#">{{ $productDetails['section']['name'] }}</a>
                            </li>
                ...
                <div class="section-4-sku-information u-s-p-y-14">
                 ...
                 @if(isset($productDetails['vendor']))
                  <div>
                      <div>Sold By : <a href="/productvendor/{{$productDetails['vendor']['id']}}" >{{$productDetails['vendor'] ['vendor_business_details'] ['shop_name'] }}</a></div>
                  </div>
                  @endif
                            ...
                            <div style="margin-top: 10px;">
                                ...
                                <div>
                                    @foreach ($groupProducts as $product )
                                        <a href="{{ url('product/'.$product['id']) }}"><img style="width: 80px;" src="{{ asset('front/images/product_image/small/'.$product['product_image']) }}"></a>
                                    @endforeach
                                </div>
                            </div>
                            @endif
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="video">
                        <div class="description-whole-container">
                            ...
                            {{-- <p class="desc-p u-s-m-b-26">{{ $productDetails['description'] }}</p> --}}
                            <img class="desc-img img-fluid u-s-m-b-26" src="{{ asset('front/images/product_image/small/'.$productDetails['product_image']) }}" alt="Product">
                            {{-- <iframe class="desc-iframe u-s-m-b-45" width="710" height="400" src="{{ asset('front/videos/product_video/'.$productDetails['product_video']) }}" allowfullscreen></iframe> --}}
