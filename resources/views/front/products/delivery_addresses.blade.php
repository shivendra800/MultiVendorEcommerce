   ...
   <form id="addressAddEditForm" action="javascript:;" method="post">@csrf
    ...
    <div class="group-inline u-s-m-b-13">
        <div class="group-1 u-s-p-r-16">
            ...
            <input type="text" name="delivery_name" id="delivery-name" class="text-field">
        ...
        <div class="group-2">
            ...
            <input type="text" name="delivery_address" id="delivery-address" class="text-field">
    ...
    <div class="u-s-m-b-13">
        ...
        <div class="select-box-wrapper">
            <select class="text-field" id="delivery-country" name="delivery_country">
    ...
    <div class="u-s-m-b-13">
        <label for="select-state-extra">State
            <span class="astk"> *</span>
        </label>
        <input type="text" name="delivery_state" id="delivery-state" class="text-field">
    ...
    <div class="u-s-m-b-13">
        ...
        <input type="text" name="delivery_city" id="delivery-city" class="text-field">
    ...
    <div class="u-s-m-b-13">
        ...
        <input type="text" name="delivery_pincode" id="delivery-pincode" class="text-field">
    ...
    <div class="group-inline u-s-m-b-13">
        <div class="group-2">
            ...
            <input type="text" name="delivery_mobile" id="delivery-mobile" class="text-field">
