...
<h4 class="section-h4">Delivery Addesses</h4>
...
<div><label class="control-label">{{ $address['name'] }},{{ $address['address'] }},{{ $address['city'] }},{{ $address['state'] }},{{ $address['pincode'] }},({{ $address['mobile'] }}).</label>
                                ...
                                <div class="order-table">
                                    ...
                                    // echo"<pre>";print_r($getDiscountAttributePrice); die;
                                        ?>
                                            <tr>
                                                <td>
                                                    <a href="{{ url('product/'.$item['product_id']) }}">
                                                        <img width="30" src="{{ asset('front/images/product_image/small/'.$item['product']['product_image']) }}" alt="Product">
                                                    <h6 class="order-h6"> {{ $item['product']['product_name'] }} ({{ $item['product']['product_code'] }}) -
                                                        {{ $item['size'] }}<br>
                                                        Color: {{ $item['product']['product_color'] }}<br></h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <h6 class="order-h6">Shipping Chargers</h6>
                                                </td>
                                                <td>
