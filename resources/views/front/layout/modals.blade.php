                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
                          <div class="newsletter-image">
                              <a target="_blank" rel="nofollow" href="#" class="banner-hover effect-dark-opacity">
                                  <img class="img-fluid" src="{{ url('front/images/banner_images/shivendralogo.png')}}" alt="Newsletter Image">
  </a>
  </div>
  </div>
              ...
              <div class="modal-body">
                  <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-12">
                          <!-- Product-zoom-area -->
                          <div class="zoom-area">
                              <img id="zoom-pro-quick-view" class="img-fluid" src="{{ url('front/images/product/product@4x.jpg')}} data-zoom-image=" images/product/product@4x.jpg" alt="Zoom Image">
  <div id="gallery-quick-view" class="u-s-m-t-10">
      <a class="active" data-image="images/banner_images/shivendralogo.png" data-zoom-image="images/banner_images/shivendralogo.png">
          <img src="{{ url('front/images/banner_images/shivendralogo.png')}}" alt="Product">
      </a>
      <a data-image="images/banner_images/shivendralogo.png" data-zoom-image="images/banner_images/shivendralogo.png">
          <img src="{{ url('front/images/banner_images/shivendralogo.png')}}" alt="Product">
      </a>
      <a data-image="images/banner_images/shivendralogo.png" data-zoom-image="images/banner_images/shivendralogo.png">
          <img src="{{ url('front/images/banner_images/shivendralogo.png')}}" alt="Product">
