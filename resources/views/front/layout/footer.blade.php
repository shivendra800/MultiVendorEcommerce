       ...
       <div class="container">
                       ...
                       <div class="footer-list">
                           ...
                           <ul>
                               <li>
                                   ...
                                   <span>Shivendra Developers Youtube Channel</span>
                               </li>
                               <li>
                                   <a href="tel:+918004476407">
                                       <i class="fas fa-phone u-s-m-r-9"></i>
                                       <span>+918004476407</span>
                                   </a>
                               </li>
                               <li>
                                   <a href="mailto:shivendrat480@gmail.com">
                                       <i class="fas fa-envelope u-s-m-r-9"></i>
                                       <span>
                                           shivendrat480@gmail.com</span>
                                   </a>
                               </li>
                           </ul>
                       </div>
           ...
           <div class="bottom-footer-wrapper">
               ...
               <p class="copyright-text">Copyright &copy; 2022
                   <a target="_blank" rel="nofollow" href="#">Shivendra Developers</a> | All Right Reserved</p>
           </div>
       </div>
       <!-- Bottom-Footer /- -->
   </footer>
