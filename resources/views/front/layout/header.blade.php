...
<header>
        ...
        <div class="container clearfix">
            <nav>
                <ul class="primary-nav g-nav">
                    <li>
                        <a href="tel:+91 8004476407">
                            <i class="fas fa-phone u-c-brand u-s-m-r-9"></i>
                            Telephone:+91 8004476407</a>
                    </li>
                    <li>
                        <a href="mailto:shivendrat757@gmail.com">
                            <i class="fas fa-envelope u-c-brand u-s-m-r-9"></i>
                            E-mail: shivendrat757@gmail.com
                        </a>
                    </li>
                </ul>
            </nav>
            ...
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        <a href="{{ url('/') }}">
                            <img src="{{ url('front/images/main-logo/shivendralogo.png') }}" alt="Stack Developers" class="app-brand-logo" style="width:100%;">
    ...
    <div id="appendHeaderCartItems">
        @include('front.layout.hearder_cart_items')
    </div>
    <!-- Mini Cart /- -->
    <!-- Bottom-Header -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-9">
                    <ul class="bottom-nav g-nav u-d-none-lg">
                        <li>
                            <a href="{{ url('new-arravials') }}">New Arrivals
                                <span class="superscript-label-new">NEW</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('best-seller') }}">Best Seller
                                <span class="superscript-label-hot">HOT</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('featured-product') }}">Featured
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('discount-product') }}">Discounted
