    ...
    <div class="container">
        <div class="page-intro" >
            ...
            <ul class="bread-crumb">
                ...
                <li class="is-marked">
                    <a href="{{ url('user/orders') }}">Order List</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
               <table class="table  table-striped table-borderless">
                     ...
                     <tr><td>Place Order Date</td><td>{{  date('Y-m-d h:i:s',strtotime($orderDetails['created_at'])); }}</td></tr>
                     <tr><td>Order Status</td><td>{{ $orderDetails['order_status'] }}</td></tr>
                     <tr><td>Order Total Amount </td><td>{{ $orderDetails['grand_total'] }}</td></tr>
                     <tr><td>Shipping Chargers </td><td>{{ $orderDetails['shipping_charges'] }}</td></tr>
                        ...
                        @foreach ($orderDetails['orders_products'] as $product )
                           <tr>
                            <td>
                                ...
                                <a href="{{ url('product/'.$product['product_id']) }}"><img style="width:80px" src="{{ asset('front/images/product_image/small/'.$getProductImage) }}"></a>
                            </td>
                            ...
                            @if($product['item_courier_name']!="")
                            <tr><td colspan="6">Courier Name: {{ $product['item_courier_name'] }},Tracking Number: {{ $product['item_tracking_number'] }}</td></tr>
                            @endif
                        @endforeach

                    <table class="table table-striped table-borderless">
                        <tr><td colspan="2"><strong>Delivery Address Details</strong></td></tr>
                        ...
                        <tr><td>Mobile No </td><td>{{ $orderDetails['mobile'] }}</td></tr>
                       </table>
