            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a style="max-width: 150px; float:right; display:inline-block;" href="{{ url('admin/add-edit-cmspages') }}" class="btn btn-block btn-primary">Add</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a title="Edit Product Details" href="{{ url('admin/add-edit-cmspages/'.$page['id'] ) }}" <i style="font-size:25px;" class="mdi mdi-pencil"></i></a>
                                            <a title="Delete Product" href="javascript:void(0)" class="confirmDelete" module="page" moduleid="{{ $page['id'] }}"><i style="font-size:25px;" class="mdi mdi-delete"></i></a>
                                        </td>
