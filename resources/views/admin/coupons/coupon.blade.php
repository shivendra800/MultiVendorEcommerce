                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <a class="updatecouponStatus" id="section-{{ $coupon['id'] }}" coupon_id="{{ $coupon['id'] }}" href="javascript:void(0)">
                                                <i style="font-size:25px;" class="mdi mdi-bookmark-outline" status="Inactive"></i></a>
                                            @endif
                                        </td>
                                        <td>

                                            <a title="Edit Coupon Details" href="{{ url('admin/add-edit-coupon/'.$coupon['id'] ) }}" <i style="font-size:25px;" class="mdi mdi-pencil"></i></a>
                                            {{-- <a title="coupon" class="confirmDelete"  href="{{ url('admin/delete-coupon/'.$coupon['id'] ) }}" ><i style="font-size:25px;" class="mdi mdi-file-excle-box"></i>d</a> --}}
                                            <a title="Delete Coupon" href="javascript:void(0)" class="confirmDelete" module="coupon" moduleid="{{ $coupon['id'] }}""><i style="font-size:25px;" class="mdi mdi-delete"></i></a>
                                        </td>
