                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if(!empty($product['product_image']))
                                            <img style="width: 60px; height:60px;" src=" {{ asset('front/images/product_image/small/'.$product['product_image']) }}"
                                            @else
                                            <img style="width: 60px; height:60px;" src=" {{ asset('front/images/product_image/small/no-image.png') }}"
                                        @endif
                                             </td>
                                        ...
                                        <td>
                                            ...
                                            <a title="Edit Product Details" href="{{ url('admin/add-edit-product/'.$product['id'] ) }}" <i style="font-size:25px;" class="mdi mdi-pencil"></i></a>
                                            <a title="Add Multiple Images" href="{{ url('admin/add-images/'.$product['id']) }}"><i style="font-size:25px;" class="mdi mdi-image-multiple"></i></a>
                                            <a title="Add Product Attribute" href="{{ url('admin/add-attributes/'.$product['id']) }}"><i style="font-size:25px;" class="mdi mdi-plus-box"></i></a>
                                            <a title="Delete Product" href="javascript:void(0)" class="confirmDelete" module="product" moduleid="{{ $product['id'] }}"><i style="font-size:25px;" class="mdi mdi-delete"></i></a>
