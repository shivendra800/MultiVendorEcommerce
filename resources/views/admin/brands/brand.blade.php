                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <a class="updatebrandStatus" id="section-{{ $brand['id'] }}" brand_id="{{ $brand['id'] }}" href="javascript:void(0)">
                                                <i style="font-size:25px;" class="mdi mdi-bookmark-outline" status="Inactive"></i></a>
                                            @endif
                                        </td>
                                        <td>

                                            <a title="Edit Product Details" href="{{ url('admin/add-edit-brand/'.$brand['id'] ) }}" <i style="font-size:25px;" class="mdi mdi-pencil"></i></a>
                                            {{-- <a title="brand" class="confirmDelete"  href="{{ url('admin/delete-brand/'.$brand['id'] ) }}" ><i style="font-size:25px;" class="mdi mdi-file-excle-box"></i>d</a> --}}
                                            <a title="Delete Product" href="javascript:void(0)" class="confirmDelete" module="brand" moduleid="{{ $brand['id'] }}""><i style="font-size:25px;" class="mdi mdi-delete"></i></a>
                                        </td>
