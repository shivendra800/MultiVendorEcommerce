            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a style="max-width: 150px; float:right; display:inline-block;" href="{{ url('admin/filters') }}" class="btn btn-block btn-primary">View Filter</a>
                        <a style="max-width: 150px; float:left; display:inline-block;" href="{{ url('admin/add-edit-filter-value') }}" class="btn btn-block btn-primary">Add Filter Value</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a title="Delete filter" href="javascript:void(0)" class="confirmDelete" module="filterValues" moduleid="{{ $filter['id'] }}"><i style="font-size:25px;" class="mdi mdi-delete"></i></a>
