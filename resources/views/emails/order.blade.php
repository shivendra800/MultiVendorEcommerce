...
<body>
    ...
    <tr><td>
        ...
        <tr><td>
            ...
            <tr><td>&nbsp;</td></tr>
            <tr><td> Download Order Invoice at <a href="{{ url('download-invoice/'.$orderDetails['id'].'') }}">{{ url('download-invoice/'.$orderDetails['id'].'') }}</a><br>(Copy & Paste to Open if link does not work )</td></tr>
            <tr><td>&nbsp;</td></tr>
